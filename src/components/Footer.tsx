      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-blue-100/60 hover:text-white transition-colors font-semibold flex items-center gap-2 group text-xs uppercase tracking-wider"><ExternalLink className="w-3 h-3 group-hover:scale-110 transition-transform" /> Secretaria de Ciência e Tecnologia</a></li>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          <div className="space-y-4">
            <p className="text-[10px] font-black uppercase tracking-[0.25em] text-blue-100/40">
              Desenvolvido para a Secretaria de Ciência e Tecnologia &bull; Prefeitura de Maricá
            </p>
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-100/30">
              &copy; 2026 GOVVIVA - Secretaria Municipal de Ciência e Tecnologia
            </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="opacity-40 hover:opacity-100 transition-opacity">
              <MaricaLogo variant="white" height={40} />
            </div>
